...
function App() {
  return (
    <div className="App">
      ...
      <h1 className='italic font-semibold	 text-xl lg:text-7xl	'>Welcome to <span className='text-primary'>Team Thunder's</span> portfolio</h1>
      <h3 className='text-xl'>We are rusher...We never give up...</h3>
      <Players></Players>
      <footer className="footer footer-center p-4 bg-primary text-neutral-content">
        <div className="items-center grid-flow-col text-black">
          ...
          <p>Copyright © 2022 - Salamun Hasan</p>
        </div>
      </footer>
    </div>
  );
